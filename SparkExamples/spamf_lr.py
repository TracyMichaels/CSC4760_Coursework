...
sms_data = spark_context.textFile("/home/rob/data/SMSSpamCollection.csv")
...
pipeline = Pipeline(stages = [tokenizer, hashing_tf, idf, lr_classifier])

# Fit the training data to the classifier to create the Logistic Regression Model
lr_model = pipeline.fit(training_data)
