...
idf_features_model = pipeline.fit(training_data)

idf_features = idf_features_model.transform(training_data)
idf_features.write.json("/home/rob/data/idf_features.json")
idf_features.show()